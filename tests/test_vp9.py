...
def test_vp9_streams(stream_name):
    ...
    if CNM_REFC_TEST == True:
        ...
        ret = decode_cnm_ref_c(REFC_FILE_PATH_vp9, CODEC_STR_vp9, file_name_list, False, False)
        assert ret == True

        ret = decode_cnm_ref_c(REFC_FILE_PATH_vp9, CODEC_STR_vp9, file_name_list, True, False)
        assert ret == True
        ...
        ret = decode_cnm_ref_c(REFC_FILE_PATH_vp9, CODEC_STR_vp9, file_name_list, False, True)
        assert ret == True
